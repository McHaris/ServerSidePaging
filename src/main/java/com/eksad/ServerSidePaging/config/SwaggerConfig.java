package com.eksad.ServerSidePaging.config;
...
public class SwaggerConfig {
	...
	public Docket eksadAPI() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.eksad.ServerSidePaging"))
				.paths(regex("/api.*"))
				.build()
			//	.apiInfo(metaInfo()
				.tags(
	...
	private ApiInfo metaInfo() {
		ApiInfo apiInfo = new ApiInfo(
				...
				"1.0.0",
				"http://google.com",
				new Contact("Haris Manaf", "http://www.haris.com", "harismanaf96@gmail.com"),
				"Haristech 2.0",
